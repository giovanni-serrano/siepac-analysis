"""
etl_consumo_final_total.py — Consumo final total de electricidad
====================================================
Etapa del pipeline : ETL
Entradas           : data/raw/consumo_final_total/*.xlsx (hoja "1.CONSUMO FINAL")
Salidas            : data/processed/consumo_final_total.csv (tidy)
Alimenta           : ECO1, ECO2, ECO3
Fuente de datos    : SIELAC-OLADE (Series de oferta y demanda)

Uso:  python src/etl_consumo_final_total.py   (ejecutar desde la raíz del proyecto)

Notas metodológicas:
  - La hoja viene en bloques verticales por año ("CONSUMO FINAL - AAAA");
...
RAW_DIR = DIR_RAW / "consumo_final_total"
PROCESSED_DIR = DIR_PROCESSED

ARCHIVO_SALIDA = PROCESSED_DIR / "consumo_final_total.csv"

HOJA = "1.CONSUMO FINAL"

PAISES_VALIDOS = set(PAISES_SIEPAC)
YEAR_PATTERN = re.compile(r"CONSUMO FINAL - (\d{4})")
